...
describe("reefOutboundAdapter", () => {
  it("normalizes the SDK target and delegates only message content/context to the guarded flow", async () => {
    ...
    await expect(reefOutboundAdapter.sendText!({
      cfg: {}, accountId: "default", to: "reef:Alice", text: "hello",
      threadId: 42, replyToId: "01JZ0000000000000000000199",
    ...
    expect(send).toHaveBeenCalledWith("alice", "hello", { thread: "42", replyTo: "01JZ0000000000000000000199" });
  });
});
